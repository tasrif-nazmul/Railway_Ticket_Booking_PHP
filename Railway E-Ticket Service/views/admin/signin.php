...
<head>
    ...
    <link rel="stylesheet" href="../../assects/css/admin/signin.css">
</head>
<body>
<form action="../../controllers/admin/signinVal.php" method="post">
    <div class="login-div">
        ...
        <div class="sub-title">Admin Portal</div>
        <div class="fields">
        <div class="username_err">Must be fillup your username</div>
            <div class="usernamee">
            ...
            <div class="password_err">Must be fillup your password</div>
            <div class="password">
                <svg fill='#999' class="svg-icon" viewBox="0 0 20 20">
